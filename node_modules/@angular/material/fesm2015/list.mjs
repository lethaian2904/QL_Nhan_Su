...
class _MatListItemGraphicBase {
    ...
    _isAlignedAtStart() {
        ...
        return !this._listOption || ((_a = this._listOption) === null || _a === void 0 ? void 0 : _a._getTogglePosition()) === 'after';
    }
}
...
class MatListItemBase {
    ...
    get disableRipple() {
        ...
        return (this.disabled ||
            ...
            !!((_a = this._listBase) === null || _a === void 0 ? void 0 : _a.disableRipple));
    }
    set disableRipple(value) {
        this._disableRipple = coerceBooleanProperty(value);
    }
    ...
    get disabled() {
        var _a;
        return this._disabled || !!((_a = this._listBase) === null || _a === void 0 ? void 0 : _a.disabled);
    }
    set disabled(value) {
        this._disabled = coerceBooleanProperty(value);
    }
    ...
    _updateItemLines(recheckUnscopedContent) {
        ...
        const numberOfLines = (_a = this._explicitLines) !== null && _a !== void 0 ? _a : this._inferLinesFromContent();
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.0-rc.0", ngImport: i0, type: MatListItemBase, decorators: [{
        ...
        return [{ type: i0.ElementRef }, { type: i0.NgZone }, { type: MatListBase, decorators: [{
                        type: Optional
...
class MatListOption extends MatListItemBase {
    ...
    getLabel() {
        var _a, _b, _c;
        const titleElement = (_b = (_a = this._titles) === null || _a === void 0 ? void 0 : _a.get(0)) === null || _b === void 0 ? void 0 : _b._elementRef.nativeElement;
        // If there is no explicit title element, the unscoped text content
        // is treated as the list item title.
        const labelEl = titleElement || ((_c = this._unscopedContent) === null || _c === void 0 ? void 0 : _c.nativeElement);
